...
<header>
    ...
    <section id="showcase">
        <div class="container">
            <h1>Criamos websites profissionais</h1>
    ...
    <section id="newsletter">
        <div class="container">
            <h1>Clientes</h1>
            <form>
                <a href="create_employee.php" class="button_2">Cadastrar Clientes</a>
            </form>
        </div>
    </section>
    ...
    <section id="boxes">
        <div class="container">
            <div class="box">
                <img src="assets/images/html_logo.png">
                <h3>HTML 5 Markup</h3>
            ...
            <div class="box">
                <img src="assets/images/css_logo.png">
                <h3>CSS 3 Styling</h3>
            ...
            <div class="box">
                <img src="assets/images/graphics.jpg">
...
<footer>
    <p>Magaia Web Design, Todos os direitos reservados &copy; 2021</p>
  </footer>
</body>
